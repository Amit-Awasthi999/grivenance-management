...
<head>
    <meta charset="UTF-8">
    <title>Editable Datatables |  Admin Template</title>
                            ...
                            <div id="sample_editable_1_wrapper" class="">
                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                    ...
                                    <tr role="row" class="odd" data-id="1">
                                        ...
                                        <td>
                                            <a  href="edit_complaint.php?qid=<?php echo $row['id']; ?>">Edit </a>
                                        </td>
                                        <td>
                                            <a  href="admin_delete.php?qid=<?php echo $row['id']; ?>" name="deasy">Delete</a>
                                        </td>
                                        <td>
                                            <a  href="send.php?qid=<?php echo $row['id']; ?>" name="deasy">send
