...
$email=$_REQUEST['email'];
 ...
 $com_about=$_POST['complaint_about'];
            $_SESSION['com_about']=$com_about;
$complaint=$_POST['complaint'];
            $_SESSION['complaint']=$complaint;
$file=$_POST["image"];
            $_SESSION['file']=$file;
if($username==""  ){
   header('location:complaint_form.php?err=1');
}
if($email==""  ){
    header('location:complaint_form.php?err=1');
 }
...
<body class="skin-josh">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active" id="active">
                                    <a href="form_builder2.html">
                                        <i class="fa fa-angle-double-right"></i> Complaint Form
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="form_editor2.html">
                                        <i class="fa fa-angle-double-right"></i> Form Editors 2
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="datepicker.html">
                                        <i class="fa fa-angle-double-right"></i> Data Pickers
                                    </a>
                                </li>
                                <li>
    ...
    <a id="back-to-top" href="#" class="btn btn-primary btn-lg back-to-top" role="button" title="Return to top" data-toggle="tooltip" data-placement="left">
        <i class="livicon" data-name="plane-up" data-size="18" data-loop="true" data-c="#fff" data-hc="white"></i>
                ...
                <div class="check">
                    <form method="post" action="store_db.php">
                        <h4> |->   username :<?php echo $username?></h4><br>
                        <h4> |->   Email :<?php echo $email?></h4><br>
                        <h4> |->   Complaint About:<?php echo $com_about?></h4><br>
                        <h4> |->    Image Name:<?php echo $file?></h4><br>
                        <h4> |->    Complaint detail:<?php echo $complaint?></h4><br>
                        <button class="button" id="button1" ><a href="complaint_form.php" style="color:black;">back</a></button>
                        <button class="button" id="button2" name="confirm"><a style="color:black;">confirm</a></button>
                    </form>
                </div>
    <!-- global js -->
